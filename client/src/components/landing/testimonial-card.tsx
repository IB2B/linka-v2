...
export function TestimonialCard({ item }: { item: Testimonial }) {
  return (
    <figure className="flex w-[330px] shrink-0 flex-col justify-between gap-5 rounded-xl bg-[#FAFAFB] p-5 shadow-[0_1px_2px_rgba(15,17,19,0.04)] ring-1 ring-[#E4E4EA] transition duration-200 hover:bg-white hover:ring-[#CFC9F7]">
      {item.metric && (
      ...
      <figcaption className="flex items-center gap-2.5 border-t border-[#E8E8EE] pt-4">
