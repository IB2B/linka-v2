...
export function UsageCard({ overview }: { overview: BillingOverview | null }) {
      ...
      <CardContent className="space-y-2">
        <div className="flex items-baseline justify-between">
          ...
          <span className="text-sm font-medium tabular-nums">
            {postsThisMonth}/{postsLimit} posts
          </span>
        </div>
        ...
        <p className="text-xs text-muted-foreground">{percent}% used this month</p>
      </CardContent>
    </Card>
  );
}
